...
h:Reflect.get(b,l)},has:function(h,l,f){return h.hasOwnProperty(l)||window[l]?Reflect.has(h,l,f):!0}});return(new Function("$context","with($context){ "+a+"}"))(m)}catch(h){console.error(h)}}function v(a,c,b){return b?q("return "+b,a,null,{element:c,type:"HypeReactiveScope"}):null}function y(a,c,b){!1==="HypeActionEvents"in window&&(c=b.customBehaviorName,"#"!=c.charAt(0)&&/[;=()]/.test(c)&&q(c,a,a.customData))}var z=-1!=window.location.href.indexOf("/Hype/Scratch/HypeScratch.");_default={highlightReactiveContent:!0,
highlightVisibilityData:!0,highlightVisibilityArea:!0,highlightContentData:!0,highlightScopeData:!0,scopeSymbol:"\u21e2",scopeSymbolLength:1,visibilitySymbol:"\ud83d\udc41"};var u=Symbol("isProxy");!1==="HYPE_eventListeners"in window&&(window.HYPE_eventListeners=[]);window.HYPE_eventListeners.push({type:"HypeDocumentLoad",callback:function(a,c,b){a.refreshReactiveContent=function(e,m,h,l){void 0===e||void 0===m||/[;=()]/.test(m)||a.triggerCustomBehaviorNamed(e+" equals "+("string"===typeof m?'"'+
m+'"':m));void 0!==e&&(d("customDataUpdate")&&d("customDataUpdate")(e,m,h,l),a.triggerCustomBehaviorNamed("customData was changed"),a.triggerCustomBehaviorNamed(e+" was updated"));document.getElementById(a.currentSceneId()).querySelectorAll("[data-content], [data-visibility]").forEach(function(f){var g=f.getAttribute("data-content"),k=f.getAttribute("data-visibility"),n=null,p=null,r=d("scopeSymbolLength");g&&(g=g.trim(),g.startsWith(d("scopeSymbol"))?(g=g.slice(r),n=(n=f.closest("[data-scope]"))?
v(a,f,n.getAttribute("data-scope")):null):g.includes(d("scopeSymbol"))&&(n=g.slice(0,g.indexOf(d("scopeSymbol"))),n=v(a,f,n),g=g.slice(g.indexOf(d("scopeSymbol"))+r)),g=q("return "+g,a,n,{element:f,type:"HypeReactiveContent"}),f.innerHTML=void 0!==g?g:"");k&&(k=k.trim(),k.startsWith(d("scopeSymbol"))?(k=k.slice(r),p=n):k.includes(d("scopeSymbol"))&&(p=k.slice(0,k.indexOf(d("scopeSymbol"))),p=v(a,f,p),k=k.slice(k.indexOf(d("scopeSymbol"))+r)),k=q("return "+k,a,p,{element:f,type:"HypeReactiveVisibility"}),
"none"==f.style.display&&(f.style.display="block"),f.style.visibility=k?"visible":"hidden")});!1!=="HypeDataMagic"in window&&HypeDataMagic.getDefault("refreshOnCustomData")&&a.refresh()};a.refreshReactiveContentDebounced=x(a.refreshReactiveContent);a.enableReactiveCustomData=function(e){a.customData=Object.assign(a.customData,e||{});a.customData=t(a.customData,a.refreshReactiveContentDebounced)};a.enableReactiveCustomData(d("customData")||{});a.functions().HypeReactiveContent&&a.functions().HypeReactiveContent(a,
...
0)}))});return{version:"1.1.3",setDefault:function(a,c){"object"==typeof a?_default=a:_default[a]=c},getDefault:d,enableReactiveObject:t,disableReactiveObject:w,debounceByRequestFrame:x}}());
