...
function x(a,c,d){var e=h("scopeSymbol"),k=e.length,b=null;a=a.trim();a.startsWith(e)?(a=a.slice(k),b=A(c,d)):a.includes(e)&&(b=a.slice(0,a.indexOf(e)),b=z(c,d,b),a=a.slice(a.indexOf(e)+k));return{value:a,scope:b}}function C(a,c,d){!1==="HypeActionEvents"in window&&(c=d.customBehaviorName,"#"!=c.charAt(0)&&/[;=()]/.test(c)&&q(c,a,a.customData))}var B=-1!=window.location.href.indexOf("/Hype/Scratch/HypeScratch.");_default={scopeSymbol:"\u21e2",visibilitySymbol:"\u2600\ufe0f",effectSymbol:"\u26a1\ufe0f"};
B&&(_default=Object.assign(_default,{highlightReactiveContent:!0,highlightVisibilityData:!0,highlightVisibilityArea:!0,highlightActionData:!0,highlightScopeData:!0}));var v=Symbol("isProxy");!1==="HYPE_eventListeners"in window&&(window.HYPE_eventListeners=[]);window.HYPE_eventListeners.push({type:"HypeDocumentLoad",callback:function(a,c,d){function e(b,f,l,m,g){(m=b.closest("["+l+"-action]"))&&q(m.getAttribute(l+"-action"),a,null,{element:b,type:f});if((m=b.closest("["+l+"-behavior]"))&&!k[m.id]){k[m.id]=
!0;var n=m.getAttribute(l+"-behavior");w(function(){a.triggerCustomBehaviorNamed(n)})()}}var k={};a.refreshReactiveContent=function(b,f,l,m){void 0===b||void 0===f||/[;=()]/.test(f)||a.triggerCustomBehaviorNamed(t(m._key,b)+" equals "+("string"===typeof f?'"'+f+'"':f));void 0!==b&&(h("customDataUpdate")&&h("customDataUpdate")(b,f,l,m),a.triggerCustomBehaviorNamed("customData was changed"),a.triggerCustomBehaviorNamed(t(m._key,b)+" was updated"));f=document.getElementById(a.currentSceneId());k={};
f.querySelectorAll("[data-visibility], [data-content], [data-effect]").forEach(function(g){var n=g.getAttribute("data-content"),p=g.getAttribute("data-visibility"),r=g.getAttribute("data-effect");p&&(p=x(p,a,g),p=q("return "+p.value,a,p.scope,{element:g,type:"HypeReactiveVisibility"}),"none"==g.style.display&&(g.style.display="block"),p=p?"visible":"hidden",p!==g.style.visibility&&(g.style.visibility=p,b&&e(g,"HypeReactiveVisibiltyChanged","data-visibility-changed",!0,!0)));r&&(r=x(r,a,g),q(r.value,
a,r.scope,{element:g,type:"HypeReactiveEffect"}));n&&(n=x(n,a,g),n=q("return "+n.value,a,n.scope,{element:g,type:"HypeReactiveContent"}),n=void 0!==n?n:"",n!==g.innerHTML&&(g.innerHTML=n,b&&e(g,"HypeReactiveContentChanged","data-content-changed",!0,!0)))});!1!=="HypeDataMagic"in window&&HypeDataMagic.getDefault("refreshOnCustomData")&&a.refresh()};a.refreshReactiveContentDebounced=w(a.refreshReactiveContent);a.resolveClosestScope=function(b){return A(a,b)};a.enableReactiveCustomData=function(b){a.customData=
Object.assign(a.customData,b||{});a.customData=u(a.customData,a.refreshReactiveContentDebounced)};a.enableReactiveCustomData(h("customData")||{});a.functions().HypeReactiveContent&&a.functions().HypeReactiveContent(a,c,d)}});window.HYPE_eventListeners.push({type:"HypeScenePrepareForDisplay",callback:function(a,c,d){a.refreshReactiveContentDebounced()}});!1==="HypeActionEvents"in window&&window.HYPE_eventListeners.push({type:"HypeTriggerCustomBehavior",callback:C});B&&window.addEventListener("DOMContentLoaded",
function(a){h("highlightReactiveContent")&&(a=[],document.documentElement.style.setProperty("--data-reactive-color","#f8d54f"),h("highlightActionData")&&(a=a.concat(["[data-content]{outline:1px dashed var(--data-reactive-color);position:relative}","[data-content]::before{content:attr(data-content);font-family:Helvetica,Arial;line-height:11px;font-size:9px;font-weight:normal;padding:2px 5px;white-space:nowrap;max-height:16px;color:#000;text-align:center;background-color:var(--data-reactive-color);position:absolute;top:-15px;left:-1px;border-top-right-radius:.2rem;border-top-left-radius:.2rem;}",
"[data-effect]::before{content:attr(data-effect);font-family:Helvetica,Arial;line-height:11px;font-size:9px;font-weight:normal;padding:2px 5px;white-space:nowrap;max-height:16px;color:#000;text-align:center;background-color:var(--data-reactive-color);position:absolute;top:-15px;left:-1px;border-top-right-radius:.2rem;border-top-left-radius:.2rem;}"])),h("highlightVisibilityData")&&(a=a.concat(["[data-visibility]::before{content:'"+h("visibilitySymbol")+" ' attr(data-visibility);font-family:Helvetica,Arial;line-height:11px;font-size:9px;font-weight:normal;padding:2px 5px;white-space:nowrap;max-height:16px;color:#000;text-align:center;background-color:var(--data-reactive-color);position:absolute;top:-15px;left:-1px;border-top-right-radius:.2rem;border-top-left-radius:.2rem;}"])),
h("highlightScopeData")&&(a=a.concat(["[data-scope]{--data-reactive-color:#ffcccc; outline:1px dashed var(--data-reactive-color);}","[data-scope]::after{content:attr(data-scope);font-family:Helvetica,Arial;line-height:11px;font-size:9px;font-weight:normal;padding:2px 5px;white-space:nowrap;max-height:16px;color:#000;text-align:center;background-color:var(--data-reactive-color);position:absolute;bottom:-15px;left:-1px;border-bottom-right-radius:.2rem;border-bottom-left-radius:.2rem}"])),h("highlightActionData")&&
h("highlightVisibilityData")&&(a=a.concat(["[data-content][data-visibility]:not([data-effect])::before{content: attr(data-content) ' "+h("visibilitySymbol")+" ' attr(data-visibility)}","[data-content][data-visibility]::before{content: attr(data-content)  ' "+h("effectSymbol")+" ' attr(data-effect) ' "+h("visibilitySymbol")+" ' attr(data-visibility)}"])),h("highlightVisibilityArea")&&(a=a.concat(["[data-visibility]:not([data-scope])::after {content:'';position: absolute;top: 0;left: 0;width: 100%;height: 100%;background-image:repeating-linear-gradient(45deg,transparent,transparent 10px,var(--data-reactive-color) 10px,var(--data-reactive-color) 20px);opacity: .1;}"])),
a.forEach(function(c){return document.styleSheets[0].insertRule(c,0)}))});return{version:"1.2.0",setDefault:function(a,c){"object"==typeof a?_default=a:_default[a]=c},getDefault:h,enableReactiveObject:u,disableReactiveObject:y,debounceByRequestFrame:w}}());
