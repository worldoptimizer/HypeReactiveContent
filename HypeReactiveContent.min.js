...
q=A(a,l)):h.includes(e("scopeSymbol"))&&(q=h.slice(0,h.indexOf(e("scopeSymbol"))),q=z(a,l,q),h=h.slice(h.indexOf(e("scopeSymbol"))+u)),h=r("return "+h,a,q,{element:l,type:"HypeReactiveContent"}),h=void 0!==h?h:"",h!==l.innerHTML&&(l.innerHTML=h,b&&g(l,"HypeReactiveContentChanged","data-content-changed",!0,!0)));k&&(k=k.trim(),k.startsWith(e("scopeSymbol"))?(k=k.slice(u),t=q||A(a,l)):k.includes(e("scopeSymbol"))&&(t=k.slice(0,k.indexOf(e("scopeSymbol"))),t=z(a,l,t),k=k.slice(k.indexOf(e("scopeSymbol"))+
u)),k=r("return "+k,a,t,{element:l,type:"HypeReactiveVisibility"}),"none"==l.style.display&&(l.style.display="block"),k=k?"visible":"hidden",k!==l.style.visibility&&(l.style.visibility=k,b&&g(l,"HypeReactiveVisibiltyChanged","data-visibility-changed",!0,!0)))});!1!=="HypeDataMagic"in window&&HypeDataMagic.getDefault("refreshOnCustomData")&&a.refresh()};a.refreshReactiveContentDebounced=y(a.refreshReactiveContent);a.resolveClosestScope=function(b){return A(a,b)};a.enableReactiveCustomData=function(b){a.customData=
...
(a=a.concat(["[data-content][data-visibility]::before{content: attr(data-content) ' "+e("visibilitySymbol")+" ' attr(data-visibility)}"])),e("highlightVisibilityArea")&&(a=a.concat(["[data-visibility]::after {content:'';position: absolute;top: 0;left: 0;width: 100%;height: 100%;background-image:repeating-linear-gradient(45deg,transparent,transparent 10px,var(--color) 10px,var(--color) 20px);opacity: .1;}"])),a.forEach(function(c){return document.styleSheets[0].insertRule(c,0)}))});return{version:"1.1.8",
setDefault:function(a,c){"object"==typeof a?_default=a:_default[a]=c},getDefault:e,enableReactiveObject:w,disableReactiveObject:B,debounceByRequestFrame:y}}());
