...
function L(a,b,c){!1==="HypeActionEvents"in window&&(b=c.customBehaviorName,"#"!=b.charAt(0)&&/[;=()]/.test(b)&&u(b,a,a.customData))}const H=-1!=window.location.href.indexOf("/Hype/Scratch/HypeScratch."),x=new WeakMap;let v={scopeSymbol:"\u21e2",visibilitySymbol:"\ud83d\udc41\ufe0f",effectSymbol:"\u26a1\ufe0f",templateSymbol:"\ud83d\udcdd",debounceCustomDataUpdate:!0,visibilityMode:"auto",debug:!1,trackRedraws:!1,redrawHighlightDuration:250,redrawOverlayColor:"rgba(255, 0, 0, 0.2)",redrawBorderColor:"rgba(255, 0, 0, 0.5)",
redrawBorderWidth:"1px"};H&&(v=Object.assign(v,{highlightReactiveContent:!0,highlightVisibilityData:!0,highlightVisibilityArea:!0,highlightActionData:!0,highlightScopeData:!0,highlightTemplateData:!0}));let B=Symbol("isProxy");const r=new WeakMap;!1==="HYPE_eventListeners"in window&&(window.HYPE_eventListeners=[]);window.HYPE_eventListeners.push({type:"HypeDocumentLoad",callback:function(a,b,c){function e(d,f,m,n,h){(n=d.closest("["+m+"-action]"))&&u(n.getAttribute(m+"-action"),a,null,{element:d,
type:f});if((n=d.closest("["+m+"-behavior]"))&&!l[n.id]){l[n.id]=!0;let k=n.getAttribute(m+"-behavior");C(function(){a.triggerCustomBehaviorNamed(k)})()}}let l={};a.refreshReactiveContent=function(d,f,m,n){void 0===d||void 0===f||/[;=()]/.test(f)||a.triggerCustomBehaviorNamed(z(n._key,d)+" equals "+("string"===typeof f?'"'+f+'"':f));void 0!==d&&(g("customDataUpdate")&&g("customDataUpdate")(d,f,m,n),a.customDataUpdate&&a.customDataUpdate(d,f,m,n),a.triggerCustomBehaviorNamed("customData was changed"),
a.triggerCustomBehaviorNamed(z(n._key,d)+" was updated"));f=document.getElementById(a.currentSceneId());l={};f.querySelectorAll("[data-visibility], [data-content], [data-effect], [data-content-template]").forEach(function(h){var k=h.getAttribute("data-content"),q=h.getAttribute("data-visibility"),p=h.getAttribute("data-effect"),t=h.hasAttribute("data-content-template");q&&(q=w(q,a,h),q=u("return "+q.value,a,q.scope,{element:h,type:"HypeReactiveVisibility"}),"none"==h.style.display&&(h.style.display=
"block"),q=q?"visible":"hidden",q!==h.style.visibility&&(h.style.visibility=q,d&&e(h,"HypeReactiveVisibilityChanged","data-visibility-changed",!0,!0)));p&&(p=w(p,a,h),u(p.value,a,p.scope,{element:h,type:"HypeReactiveEffect"}));k?(k=w(k,a,h),k=u("return "+k.value,a,k.scope,{element:h,type:"HypeReactiveContent"}),null!==k&&(p=document.createElement("div"),(t=k instanceof HTMLElement||k instanceof DocumentFragment)?p.appendChild(k.cloneNode(!0)):(k=void 0!==k?k:"",p.innerHTML=k),p=p.innerHTML,p!==h.innerHTML&&
(t?(h.innerHTML="",h.appendChild(k)):h.innerHTML=p,D(h),d&&e(h,"HypeReactiveContentChanged","data-content-changed",!0,!0)))):t&&(k=h.getAttribute("data-content-template"),t=r.get(a)||new Map,(k=k?t.get(k):t.get(h))?(k=I(k,a,h),t=document.createElement("div"),t.innerHTML=k,k=t.innerHTML,k!==h.innerHTML&&(h.innerHTML=k,D(h),d&&e(h,"HypeReactiveTemplateChanged","data-content-template-changed",!0,!0))):h.innerHTML="")});!1!=="HypeDataMagic"in window&&HypeDataMagic.getDefault("refreshOnCustomData")&&a.refresh()};
a.refreshReactiveContentDebounced=C(a.refreshReactiveContent);a.resolveClosestScope=function(d){return G(a,d)};a.enableReactiveCustomData=function(d){const f=x.get(a)||{};a.customData=Object.assign(f,d||{})};a.setContentTemplateByName=function(d,f,m=!0){let n=r.get(a)||new Map;n.set(d,f);r.set(a,n);m&&a.refreshReactiveContentDebounced()};a.setContentTemplates=function(d,f=!0){if(d&&"object"===typeof d){for(let m in d)d.hasOwnProperty(m)&&a.setContentTemplateByName(m,d[m],!1);f&&a.refreshReactiveContentDebounced()}};
a.flushContentTemplateByName=function(d,f=!0){const m=r.get(a);m&&d&&(m.delete(d),r.set(a,m),f&&a.refreshReactiveContentDebounced())};a.flushContentTemplates=function(d=!0){const f=r.get(a);f&&(f.clear(),r.set(a,f),d&&a.refreshReactiveContentDebounced())};K(a);a.enableReactiveCustomData(g("customData")||{});a.functions().HypeReactiveContent&&a.functions().HypeReactiveContent(a,b,c)}});window.HYPE_eventListeners.push({type:"HypeScenePrepareForDisplay",callback:function(a,b,c){J(a);a.refreshReactiveContent()}});
!1==="HypeActionEvents"in window&&window.HYPE_eventListeners.push({type:"HypeTriggerCustomBehavior",callback:L});H?window.addEventListener("DOMContentLoaded",function(a){g("highlightReactiveContent")&&(a=["[data-scope] [data-content*\x3d"+g("scopeSymbol")+"],[data-scope] [data-effect*\x3d"+g("scopeSymbol")+"],[data-scope] [data-visibility*\x3d"+g("scopeSymbol")+"]{--data-reactive-color: #ffcccc}","[data-content], [data-effect], [data-visibility], [data-content-template]{--data-reactive-color: #f8d54f}"],
