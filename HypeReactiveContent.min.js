...
*/
'use strict';"HypeReactiveContent"in window===!1&&(window.HypeReactiveContent=function(){function D(a){g("trackRedraws")&&y()&&requestAnimationFrame(()=>{if(a.isConnected){var c=a.getBoundingClientRect();if(c.width!==0||c.height!==0){var d=document.createElement("div");d.className="hype-reactive-redraw-overlay";d.style.position="absolute";d.style.pointerEvents="none";d.style.zIndex="9999";d.style.top=window.scrollY+c.top+"px";d.style.left=window.scrollX+c.left+"px";d.style.width=c.width+"px";d.style.height=
c.height+"px";document.body.appendChild(d);setTimeout(()=>{d&&d.parentNode&&d.parentNode.removeChild(d)},g("redrawHighlightDuration"))}}})}function y(){return window.location.href.indexOf("127.0.0.1:")!=-1&&window.location.href.indexOf("/preview/")!=-1}function g(a){return a?v[a]:v}function z(a,c){return a?a+"."+c:c}function A(a,c,d){d=d||"";if(a==null||a[B])return a;var f=E.get(a);if(f)return f;f=new Proxy(a,{get:function(k,b,e){if(b==="_key")return d;if(b===B)return!0;k=Reflect.get(k,b,e);return typeof k===
"object"?A(k,c,z(d,b)):k},set:function(k,b,e,l){const n=Reflect.set(k,b,e,l);c(b,e,k,l);return n}});E.set(a,f);return f}function F(a){if(!a[B])return a;const c={};for(const d in a)if(a.hasOwnProperty(d)){const f=a[d];c[d]=typeof f==="object"?F(f):f}return c}function C(a){return function(){if(!a.timeout){var c=arguments;a.timeout=requestAnimationFrame(function(){a.apply(this,c);a.timeout=null}.bind(this))}}}function u(a,c,d,f){if(d){if(typeof d!=="object")return null}else{if(d===void 0)return null;
d=c.customData}f=f||{};if("HypeActionEvents"in window!==!1)return c.triggerAction(a,{element:f.element,event:{type:f.type},scope:d});try{let k=new Proxy(Object.assign({element:f.element,$elm:f.element},c),{set(b,e,l,n){return Reflect.get(b,e,n)?Reflect.set(b,e,l,n):Reflect.set(d,e,l)},get(b,e,l){return(b=Reflect.get(b,e,l))?b:Reflect.get(d,e)},has(b,e,l){return b.hasOwnProperty(e)||window[e]?Reflect.has(b,e,l):!0}});return(new Function("$context","with($context){ "+a+"}"))(k)}catch(k){g("debug")||
...
function(f,k){k=k.trim();if(f.charAt(0)==="\\")return f.substring(1);try{const b=w(k,c,d);let e=u("return "+b.value,c,b.scope,{element:d,type:"HypeReactiveTemplate"});return e!==void 0?e:""}catch(b){return""}})}function K(a){let c=document.getElementById(a.currentSceneId()),d=r.get(a)||new Map;c.querySelectorAll("[data-content-template]").forEach(function(f){const k=f.getAttribute("data-content-template"),b=f.innerHTML;k&&!d.has(k)?d.set(k,b):k||d.has(f)||d.set(f,b)});r.set(a,d)}function L(a){x.set(a,
a.customData||{});Object.defineProperty(a,"customData",{get:function(){return x.get(a)},set:function(c){c=A(c,a.refreshReactiveContentDebounced);x.set(a,c);g("debounceCustomDataUpdate")?a.refreshReactiveContentDebounced():a.refreshReactiveContent()}})}function M(a,c,d){"HypeActionEvents"in window===!1&&(c=d.customBehaviorName,c.charAt(0)!="#"&&/[;=()]/.test(c)&&u(c,a,a.customData))}const J=window.location.href.indexOf("/Hype/Scratch/HypeScratch.")!=-1,x=new WeakMap,E=new WeakMap;let v={scopeSymbol:"\u21e2",
visibilitySymbol:"\ud83d\udc41\ufe0f",effectSymbol:"\u26a1\ufe0f",templateSymbol:"\ud83d\udcdd",debounceCustomDataUpdate:!0,visibilityMode:"auto",debug:!1,trackRedraws:!1,redrawHighlightDuration:250};J&&Object.assign(v,{highlightReactiveContent:!0,highlightVisibilityData:!0,highlightVisibilityArea:!0,highlightActionData:!0,highlightScopeData:!0,highlightTemplateData:!0});const B=Symbol("isProxy"),r=new WeakMap;"HYPE_eventListeners"in window===!1&&(window.HYPE_eventListeners=[]);window.HYPE_eventListeners.push({type:"HypeDocumentLoad",
callback:function(a,c,d){function f(b,e,l,n,h){(n=b.closest("["+l+"-action]"))&&u(n.getAttribute(l+"-action"),a,null,{element:b,type:e});if((n=b.closest("["+l+"-behavior]"))&&!k[n.id]){k[n.id]=!0;let m=n.getAttribute(l+"-behavior");C(function(){a.triggerCustomBehaviorNamed(m)})()}}let k={};a.refreshReactiveContent=function(b,e,l,n){b===void 0||e===void 0||/[;=()]/.test(e)||typeof e==="object"||a.triggerCustomBehaviorNamed(z(n._key,b)+" equals "+(typeof e==="string"?'"'+e+'"':e));b!==void 0&&(g("customDataUpdate")&&
g("customDataUpdate")(b,e,l,n),a.customDataUpdate&&a.customDataUpdate(b,e,l,n),a.triggerCustomBehaviorNamed("customData was changed"),a.triggerCustomBehaviorNamed(z(n._key,b)+" was updated"));e=document.getElementById(a.currentSceneId());k={};e.querySelectorAll("[data-visibility], [data-content], [data-effect], [data-content-template]").forEach(function(h){var m=h.getAttribute("data-content"),q=h.getAttribute("data-visibility"),p=h.getAttribute("data-effect"),t=h.hasAttribute("data-content-template");
q&&(q=w(q,a,h),q=u("return "+q.value,a,q.scope,{element:h,type:"HypeReactiveVisibility"}),h.style.display=="none"&&(h.style.display="block"),q=q?"visible":"hidden",q!==h.style.visibility&&(h.style.visibility=q,b&&f(h,"HypeReactiveVisibilityChanged","data-visibility-changed",!0,!0)));p&&(p=w(p,a,h),u(p.value,a,p.scope,{element:h,type:"HypeReactiveEffect"}));m?(m=w(m,a,h),m=u("return "+m.value,a,m.scope,{element:h,type:"HypeReactiveContent"}),m!==null&&(p=document.createElement("div"),(t=m instanceof
HTMLElement||m instanceof DocumentFragment)?p.appendChild(m.cloneNode(!0)):(m=m!==void 0?m:"",p.innerHTML=m),p=p.innerHTML,p!==h.innerHTML&&(t?(h.innerHTML="",h.appendChild(m)):h.innerHTML=p,D(h),b&&f(h,"HypeReactiveContentChanged","data-content-changed",!0,!0)))):t&&(m=h.getAttribute("data-content-template"),t=r.get(a)||new Map,(m=m?t.get(m):t.get(h))?(m=I(m,a,h),t=document.createElement("div"),t.innerHTML=m,m=t.innerHTML,m!==h.innerHTML&&(h.innerHTML=m,D(h),b&&f(h,"HypeReactiveTemplateChanged",
"data-content-template-changed",!0,!0))):h.innerHTML="")});"HypeDataMagic"in window!==!1&&HypeDataMagic.getDefault("refreshOnCustomData")&&a.refresh()};a.refreshReactiveContentDebounced=C(a.refreshReactiveContent);a.resolveClosestScope=function(b){return H(a,b)};a.enableReactiveCustomData=function(b){const e=x.get(a)||{};a.customData=Object.assign(e,b||{})};a.parseTemplate=function(b,e){return I(b,a,e||c)};a.setContentTemplateByName=function(b,e,l=!0){let n=r.get(a)||new Map;n.set(b,e);r.set(a,n);
l&&a.refreshReactiveContentDebounced()};a.setContentTemplates=function(b,e=!0){if(b&&typeof b==="object"){for(let l in b)b.hasOwnProperty(l)&&a.setContentTemplateByName(l,b[l],!1);e&&a.refreshReactiveContentDebounced()}};a.flushContentTemplateByName=function(b,e=!0){const l=r.get(a);l&&b&&(l.delete(b),r.set(a,l),e&&a.refreshReactiveContentDebounced())};a.flushContentTemplates=function(b=!0){const e=r.get(a);e&&(e.clear(),r.set(a,e),b&&a.refreshReactiveContentDebounced())};L(a);a.enableReactiveCustomData(g("customData")||
{});a.functions().HypeReactiveContent&&a.functions().HypeReactiveContent(a,c,d)}});window.HYPE_eventListeners.push({type:"HypeScenePrepareForDisplay",callback:function(a,c,d){K(a);a.refreshReactiveContent()}});"HypeActionEvents"in window===!1&&window.HYPE_eventListeners.push({type:"HypeTriggerCustomBehavior",callback:M});J?window.addEventListener("DOMContentLoaded",function(a){g("highlightReactiveContent")&&(a=["[data-scope] [data-content*\x3d"+g("scopeSymbol")+"],[data-scope] [data-effect*\x3d"+
...
'.propagateVisibility[data-visibility][style*\x3d"visibility: hidden"] [data-visibility] { visibility: hidden !important; }')}c.forEach(d=>document.styleSheets[0].insertRule(d,0))});return{version:"1.6.2",setDefault:function(a,c){typeof a=="object"?v=a:v[a]=c},getDefault:g,enableReactiveObject:A,disableReactiveObject:F,debounceByRequestFrame:C}}());
