...
a.forEach(function(c){return document.styleSheets[0].insertRule(c,0)}))});return{version:"1.3.0",setDefault:function(a,c){"object"==typeof a?_default=a:_default[a]=c},getDefault:g,enableReactiveObject:v,disableReactiveObject:z,debounceByRequestFrame:x}}());
