...
function(a){g("highlightReactiveContent")&&(a=["[data-scope] [data-content*="+g("scopeSymbol")+"],[data-scope] [data-effect*="+g("scopeSymbol")+"],[data-scope] [data-visibility*="+g("scopeSymbol")+"]{--data-reactive-color: #ffcccc}","[data-content], [data-effect], [data-visibility]{--data-reactive-color: #f8d54f}"],document.documentElement.style.setProperty("--data-reactive-color","#f8d54f"),g("highlightActionData")&&(a=a.concat(["[data-content]{outline:1px dashed var(--data-reactive-color);position:relative}",
